...
class EditPage extends StatefulWidget {
  final Map jadwal;
  EditPage({super.key, required this.jadwal});
...
class _EditPageState extends State<EditPage> {
  ...
  final Map<String, List<String>> jenisLayananToThemes = {
    '1': ['Bimbingan Pribadi'],
    '2': ['Bimbingan Sosial'],
    '3': ['Kuliah', 'Kerja'], // Tambahkan pilihan tema untuk Bimbingan Karir
    '4': ['Bimbingan Belajar'],
  };
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  contentPadding:
                      EdgeInsets.zero, // Add this line to remove extra padding
                ),
              ),
            ),
          ),
                    ...
                    child: Container(
                              ...
                              child: DropdownButton<String>(
                                ...
                                items: jenisLayananDisplay.map((String title) {
                                  int index =
                                      jenisLayananDisplay.indexOf(title);
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: Color(0xFF17C2EC), // Latar belakang berwarna biru
                        ),
                        child: Center(
                          child: Text(
                            'Submit',
