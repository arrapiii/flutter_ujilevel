...
class EditPage extends StatefulWidget {
  final Map jadwalLagi;
  EditPage({super.key, required this.jadwalLagi});
...
class _EditPageState extends State<EditPage> {
  late String idjadwal;

  void initState() {
    super.initState();
    idjadwal = widget.jadwalLagi['id'].toString();
    value = widget.jadwalLagi['layanan_id'].toString();
    print(widget.jadwalLagi);
    print(idjadwal);
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Card(
                      child: Padding(
                        ...
                        child: Text(
                          widget.jadwalLagi['guru']['namaguru'] ?? 'woi',
                          style: TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.bold,
                          ),
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        controller: tema..text = widget.jadwalLagi['tema'],
                  ...
                  Positioned(
                    ...
                    child: Container(
                      margin: const EdgeInsets.symmetric(vertical: 8),
                      child: TextField(
                        controller: tempat..text = widget.jadwalLagi['tempat'],
                        style: GoogleFonts.poppins(color: Colors.black),
                        keyboardType: TextInputType.text,
                        decoration: InputDecoration(
                          hintText: 'Tempat',
                  ...
                  Positioned(
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: TextField(
                          controller: waktu..text = widget.jadwalLagi['waktu'],
                          enabled: false,
                  ...
                  Positioned(
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: TextField(
                          controller: jam..text = widget.jadwalLagi['waktu'],
                          enabled: false,
                          style: TextStyle(color: Colors.black),
                          decoration: InputDecoration(
                            hintText: 'Jam',
                    ...
                    child: GestureDetector(
                      onTap: () {
                        if (_formKey.currentState?.validate() ?? false) {
                          updateJadwal().then((value) {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => Homenew()));
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                content: Text("Berhasil merubah jadwal")));
                          });
                        } else {}
                      },
                      child: Container(
